...
const $$Localization = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Nos Bureaux", "description": "Localization", "lang": "en" }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<section class="w-full bg-white mb-16 py-8 px-8"> <h2 data-fly class="text-3xl font-bold text-center">Nos Bureaux</h2> ${renderComponent($$result2, "WorldMapPins", $$WorldMapPins, { "imageSrc": "/images/localization/worldmap.png", "title": "Our global offices" })} <div class="grid gap-8 md:grid-cols-2 items-start"> <!-- Map (left) --> <div class="aspect-[16/10] md:aspect-[4/3] w-full overflow-hidden rounded-xl shadow-sm"> <iframe title="Marseille Office Map" class="w-full h-full" loading="lazy" referrerpolicy="no-referrer-when-downgrade" src="https://www.google.com/maps?q=18%20chemin%20de%20Mimet%2013015%20Marseille%2C%20France&output=embed">
...
}, "C:/Users/arian/projects/progisud/astro-tailwind-starter-l10n-menu/src/pages/fr/localization.astro", void 0);

const $$file = "C:/Users/arian/projects/progisud/astro-tailwind-starter-l10n-menu/src/pages/fr/localization.astro";
const $$url = "/fr/localization";
